...
public partial class SpentInAccountReportYearlyBreakdownViewModel : ReportItemStatsBaseViewModel
{
    [ObservableProperty]
    private int _year;
    
    [ObservableProperty]
    private ObservableCollection<SpentInAccountReportMonthlyBreakdownViewModel> _monthlyBreakdown = [];
